...
function setBoxes() {
  ...
  if (
    (cookieState.left < state.left + 45 &&
      cookieState.left + 45 > state.left &&
      cookieState.top < state.top + 45 &&
      cookieState.top + 45 > state.top) ||
    (boxHole.left < state.left + 45 &&
      boxHole.left + 45 > state.left &&
      boxHole.top < state.top + 45 &&
      boxHole.top + 45 > state.top)
  ) {
    boxHole.left = Math.random() * 400;
    boxHole.top = Math.random() * 400;
    cookieState.left = Math.random() * 400;
